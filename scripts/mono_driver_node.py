...
class MonoDriver(Node):
    def __init__(self, node_name = "mono_py_node"):
        ...
        self.home_dir = "/ROS2_ORB_SLAM_ENV/src/ros2_orb_slam3" #! Change this to match path to your workspace
    ...
    def run_py_node(self, idx, imgz_name):
        ...
        img_msg = self.br.cv2_to_imgmsg(cv2.imread(img_look_up_path), encoding="bgr8")
